...
const sheetVariants = {
  right: "inset-y-0 right-0 h-full w-full max-w-[390px] border-l",
  left: "inset-y-0 left-0 h-full w-full max-w-[390px] border-r",
...
>(({ className, children, side = "right", ...props }, ref) => (
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-50 bg-card p-6 shadow-xl transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out",
        sheetVariants[side],
        className,
      )}
      {...props}
